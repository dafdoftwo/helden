...
export default function AddProductPage() {
  ...
  useEffect(() => {
    if (!authLoading && user) {
      ...
      router.push(`/${language}/auth/login?returnUrl=/${language}/admin/products/add`);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!formData.name || !formData.price || !formData.category_id || !mainImageFile) {
      ...
      setSuccessMessage(t('admin.products.successAdd'));
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold">{t('admin.products.addProduct')}</h1>
              ...
              <div>
                ...
                <div className="mt-1 flex flex-wrap gap-4">
                  {additionalImagePreviews.map((preview, index) => (
                    <div key={index} className="relative h-24 w-24 rounded-md overflow-hidden border border-gray-300">
                      <Image
                        src={preview}

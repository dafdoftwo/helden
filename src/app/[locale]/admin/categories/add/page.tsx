...
export default function AddCategoryPage() {
  ...
  useEffect(() => {
    if (!authLoading && user) {
      ...
      router.push(`/${language}/auth/login?returnUrl=/${language}/admin/categories/add`);
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccessMessage(t('admin.categories.successAdd'));
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8">
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-bold">{t('admin.categories.addCategory')}</h1>
